...
const translations = {
  ...
  createRepertoire: { en: "New Repertoire", zh: "新建曲目" },
  gardenEmpty: { en: "Your garden is empty. Build your first repertoire!", zh: "你的花园是空的。创建你的第一个曲目！" },
  ...
  repertoireLines: { en: "lines", zh: "条变化" },
  editRepertoire: { en: "Edit", zh: "编辑" },
  studyRepertoire: { en: "Study", zh: "学习" },
  addMove: { en: "Add Move", zh: "添加走法" },
  addBranch: { en: "Add Branch", zh: "添加分支" },
  deleteNode: { en: "Delete Branch", zh: "删除分支" },
  saveRepertoire: { en: "Save Repertoire", zh: "保存曲目" },
  repertoireSaved: { en: "Repertoire saved!", zh: "曲目已保存！" },
  repertoireName: { en: "Repertoire Name", zh: "曲目名称" },
  moveTree: { en: "Move Tree", zh: "走法树" },
  annotation: { en: "Annotation", zh: "注释" },
  engineEval: { en: "Engine Eval", zh: "引擎评估" },
  ...
  freeFeatures: { en: "3 new lines/day · 2 practices/day · 2 studies · 4 chapters/study", zh: "每日3条新变化 · 每日2次练习 · 2个研究 · 每研究4章" },
  proFeatures: { en: "Unlimited lines · Unlimited practice · Unlimited studies · Cloud sync", zh: "无限变化 · 无限练习 · 无限研究 · 云同步" },
